...
拿到这个数据的人,可以直接看到"原文", 也可以看到消息摘要的明文. 然后如果觉得感兴趣,想进一步验证这个消息是不是我们老板发出来的, 那就去拿到老板的公钥, 用老板的公钥对消息摘要密文进行解密.
...
* [How HTTPS actually works](https://robertheaton.com/2014/03/27/how-does-https-actually-work/)
* [自签名证书](https://stackoverflow.com/questions/10175812/how-to-create-a-self-signed-certificate-with-openssl)
* [相关名词](https://serverfault.com/questions/9708/what-is-a-pem-file-and-how-does-it-differ-from-other-openssl-generated-key-file)
